...
!(function (e, t) {
	...
	const c = {
		...
		on: function () {
			...
			"function" == typeof t[1] && (([a, n, r] = t), (i = void 0)),
				r || (r = !1);
			const c = a.split(" ");
			let p;
	...
	var E = {
		...
		emit() {
			...
			"string" == typeof n[0] || Array.isArray(n[0])
				? ((t = n[0]), (s = n.slice(1, n.length)), (a = e))
				: ((t = n[0].events), (s = n[0].data), (a = n[0].context || e)),
				s.unshift(a);
			return (
	...
	var k = {
		...
		slideToLoop: function (e, t, s, a) {
			...
			let n = e;
			return (
				i.params.loop && (n += i.loopedSlides), i.slideTo(n, t, s, a)
			);
		},
				...
				? ((b = !1),
				  n.resistance &&
						(i.currentTranslate =
							s.minTranslate() -
							1 +
							(-s.minTranslate() + i.startTranslate + v) ** w))
				: v < 0 &&
				  ...
				  n.resistance &&
						(i.currentTranslate =
							s.maxTranslate() +
							1 -
							(s.maxTranslate() - i.startTranslate - v) ** w)),
	...
	function I(e) {
		...
		for (
			...
			void 0 !== r[e + t]
				...
				: h >= r[e] &&
				  ((m = e), (f = r[r.length - 1] - r[r.length - 2]));
		}
		let g = null,
			v = null;
		a.rewind &&
	...
	var _ = {
		attachEvents: function () {
			...
			(e.onTouchStart = O.bind(e)),
				...
				i.touch &&
					!G &&
					(t.addEventListener("touchstart", N), (G = !0)),
				H(e, "on");
		},
			...
			breakpoints: {
				...
				getBreakpoint: function (e, t, s) {
					...
					for (let e = 0; e < l.length; e += 1) {
						...
						"window" === t
							? i.matchMedia(`(min-width: ${r}px)`).matches &&
							  (a = n)
							: r <= s.clientWidth && (a = n);
					}
					return a || "max";
	...
	class X {
		constructor() {
			...
			(n.__swiper__ = !0),
				(n.support = T()),
				(n.device = x({ userAgent: t.userAgent })),
				(n.browser = S()),
				(n.eventsListeners = {}),
		...
		function (e) {
			...
			function p() {
				...
				"custom" === s.type && s.renderCustom
					? (n.html(s.renderCustom(t, p + 1, u)),
					  i("paginationRender", n[0]))
					: i("paginationUpdate", n[0]),
					t.params.watchOverflow &&
						t.enabled &&
				...
				setTranslate: () => {
					...
					for (let s = 0; s < e.length; s += 1) {
						const a = e.eq(s),
							o = a[0].progress,
							d = Math.min(
								Math.max(a[0].progress, -n.limitProgress),
								n.limitProgress
							);
						let c = d;
						l ||
